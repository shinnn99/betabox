...
Mở https://betabox.betacom.agency/dashboard
...
1. Mở https://betabox.betacom.agency/dashboard/videos
...
**Muốn đổi số ngày:** vào https://betabox.betacom.agency/dashboard/settings/warehouse-config → mục "Thời gian lưu video" → nhập số → Lưu. Chỉ owner tổ chức đổi được. Hỏi [Hạnh] trước khi đổi vì phải cân với dung lượng ổ.
