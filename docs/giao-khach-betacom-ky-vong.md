...
**Muốn đổi số ngày:** vào https://betabox.vercel.app/dashboard/settings/retention → nhập số → Lưu. Chỉ owner tổ chức đổi được. Hỏi [Hạnh] trước khi đổi vì phải cân với dung lượng ổ.
